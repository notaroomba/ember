...
/* Default timeout for I2C operations (ms) */
#ifndef ssd1306_I2C_TIMEOUT
#define ssd1306_I2C_TIMEOUT 20000
#endif

/* Number of pages in the display (height / 8) */
#ifndef SSD1306_PAGES
#define SSD1306_PAGES (SSD1306_HEIGHT / 8)
#endif

/* Simple state defines used by the DMA transfer state machine */
#ifndef SSD1306_STATE_READY
#define SSD1306_STATE_READY 0
#endif
#ifndef SSD1306_STATE_BUSY
#define SSD1306_STATE_BUSY 1
#endif
#ifndef SSD1306_I2C_ERROR
#define SSD1306_I2C_ERROR 2
#endif
...
/* Backwards-compatible color enum used by some driver variants */
typedef enum {
    Black = SSD1306_PX_CLR_BLACK,
    White = SSD1306_PX_CLR_WHITE
} SSD1306_COLOR;
