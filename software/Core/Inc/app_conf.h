 ...
 */
#define CFG_GAP_DEVICE_NAME             "EMBER"
...
#define ADV_TYPE   HCI_ADV_TYPE_ADV_IND

/* Advertising filter policy: no whitelist (allow all) */
#define ADV_FILTER HCI_ADV_FILTER_NO
